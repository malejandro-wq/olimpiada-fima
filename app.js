...
const QUESTIONS = [

    {
        ...
        text:
            "Si f(x) = x² − 6x + 5, ¿cuál es el valor mínimo de la función?",
...

    {
        ...
        text:
            "Determine el valor de x si 2x + 7 = 19.",
...

    {
        ...
        text:
            "Un triángulo rectángulo tiene catetos de 3 cm y 4 cm. Determine su área.",
...

    {
        ...
        text:
            "Un móvil parte del reposo con aceleración constante de 2 m/s² durante 5 s. ¿Qué distancia recorre?",
...

    {
        ...
        text:
            "¿Qué ley relaciona el flujo eléctrico neto a través de una superficie cerrada con la carga encerrada?",
...

    {
        ...
        text:
            "Una onda tiene una frecuencia de 75 Hz y una cresta recorre 14 m en 12 s. Determine su longitud de onda.",
...
function submitAnswer(
    ...
    if (
        ...
        setFeedback(
            id,
            "Escriba o seleccione una respuesta.",
            "incorrect"
        );
...
function resetCompetition() {
    ...
    const ok =
        confirm(
            ...
            "¿Seguro que quieres reiniciar la prueba? " +
            "Se borrarán tus respuestas."
        ...
        () => {
            ...
            const ok =
                confirm(
                    ...
                    "¿Quieres finalizar la competencia? " +
                    "Después no podrás responder más preguntas."
